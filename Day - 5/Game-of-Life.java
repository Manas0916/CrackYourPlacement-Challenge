class Solution 
{
    public void gameOfLife(int[][] board) 
    {
        ...
        for(int r = 0; r < rows; r++)
        {
            ...
            {
                int liveNeighbors = neighbor(board, r-1, c-1) + 
                    neighbor(board, r-1, c) + neighbor(board, r-1, c+1) + 
                    neighbor(board, r, c+1) + neighbor(board, r+1, c+1) + 
                    neighbor(board, r+1, c) + neighbor(board, r+1, c-1) + 
        ...
        for(int r = 0; r < rows; r++)
            ...
            // copy all tempBoard elements back to board matrix
    }
